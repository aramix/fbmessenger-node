...
exports.QuickReplies = exports.QuickReply = undefined;
...
class QuickReply {
  constructor({
    ...
    if (_constants.QUICK_REPLY_TYPES.indexOf(content_type) === -1) {
...
class QuickReplies {
  constructor(quickReplies) {
    ...
    if (quickReplies.length > _constants.QUICK_REPLY_LIMIT) {
      throw new Error(`You cannot have more than ${_constants.QUICK_REPLY_LIMIT} quick replies.`);
    }
